...
function mouseMoveHandler(e) {
    ...
    // if(relativeX > paddleWidth && relativeX < canvas.width-paddleWidth/2) {
    //         paddleX =paddleWidth/2+ relativeX - paddleWidth/2;
    //     }
}
    ...
    if(y + dy < ballRadius){
        ...
        //if no paddle hit, body of canvas is hit ==> game over
            ...
            if (life ===0){
                ...
                alert('Num of lives remaining: '+life)
            }
